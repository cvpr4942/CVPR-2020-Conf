...
parser.add_argument("-d", "--data_list", type=str, default="data/multi_PIE_crop_128/selected_VS_200_9.txt")
parser.add_argument('--outf', default='./output/VS', help='folder to output images and model checkpoints')
parser.add_argument('--modelf', default='./output/VS', help='folder to output images and model checkpoints')
parser.add_argument('--epochs', default=300, type=int, metavar='N',
                    help='number of total epochs to run')
parser.add_argument("-b", "--batch_size", type=int, default=36) # 16
# parser.add_argument("-ns", "--nsnapshot", type=int, default=50)
